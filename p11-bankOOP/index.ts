...
class Customer {
    ...
    constructor(firstName: string, lastName: string, accountNumber: string, initialBalance: number) {
...
class Bank {
    ...
    createAccount(firstName: string, lastName: string, initialBalance: number): Customer {
    ...
    withdraw(customer: Customer, amount: number): void {
